...
- **Backend Development**: REST APIs, basic database operations, caching strategies
- **DevOps**: Docker containerization, service orchestration
- **Testing**: Unit tests, integration tests, TDD practices
- **Architecture**: Clean code, layered design, standard Go project structure
...
- **Production Ready**: 1
- **Languages**: Go
- **Technologies**: PostgreSQL, Redis, Docker, Docker Compose